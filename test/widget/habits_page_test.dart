...
void main() {
  group('HabitsPage Widget Tests', () {
    ...
    testWidgets('Muestra "No tienes hábitos" si lista vacía',
    ...
    testWidgets('Muestra lista con hábitos existentes',
        (WidgetTester tester) async {
      // Arrange
    ...
    testWidgets('Tap en checkbox → completa hábito (verifica Firestore)',
        (WidgetTester tester) async {
      // Arrange
    ...
    testWidgets('Llenar dialog + confirmar → crea hábito (verifica Firestore)',
        (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(
        UncontrolledProviderScope(
    ...
    testWidgets('Tap delete + confirmar → elimina hábito (verifica Firestore)',
        (WidgetTester tester) async {
      // Arrange
      final habit = HabitModel.create(
        id: 'habit-to-delete',
