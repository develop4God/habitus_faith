...
void main() {
  group(
    ...
    () {
      ...
      testWidgets('3. Edit habit has save/cancel buttons on top',
          (tester) async {
        ...
        final saveButton = find
                .widgetWithIcon(ElevatedButton, Icons.check)
                .evaluate()
                .isNotEmpty
      ...
      testWidgets('8. Habits can be reordered by drag and drop',
          (tester) async {
        final testHabits = [
          Habit.create(
            id: 'habit_1',
