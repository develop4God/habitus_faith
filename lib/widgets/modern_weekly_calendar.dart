            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final completedHabits = widget.habits.where((h) => h.completionHistory.any((dt) => dt.year == day.year && dt.month == day.month && dt.day == day.day)).toList();
                  final totalHabits = widget.habits.length;
                  final progress = totalHabits > 0 ? completedHabits.length / totalHabits : 0.0;
                  return AnimatedContainer(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${day.day}',
                          style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isToday ? Colors.blue : Colors.black),
                        ),
                        ...
                        Stack(
                          ...
                          children: [
                            ...
                            if (completedHabits.isNotEmpty)
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: completedHabits.take(2).map((habit) => Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 2),
                                  child: Text(habit.emoji ?? '✔️', style: const TextStyle(fontSize: 14)),
                                )).toList(),
                              ),
                          ],
                        ),
                        if (completedHabits.length == totalHabits && totalHabits > 0)
