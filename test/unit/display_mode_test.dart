  ...
  group('DisplayMode Unit Tests', () {
    group('Enum Values', () {
      test('has two enum values: compact and advanced', () {
        ...
        expect(DisplayMode.values.contains(DisplayMode.compact), true,
      ...
      test('compact mode is the first enum value', () {
        expect(DisplayMode.values[0], DisplayMode.compact,
    ...
    group('Deserialization', () {
      test('deserializes "compact" to compact mode', () {
        ...
        expect(result, DisplayMode.compact,
    ...
    group('Round-trip Serialization', () {
      test('compact mode survives round-trip', () {
        ...
        expect(deserialized, DisplayMode.compact,
    ...
    group('Security Tests', () {
      test('handles SQL injection-like strings', () {
        final sqlInjection =
            DisplayMode.fromStorageString("compact'; DROP TABLE users; --");
        expect(sqlInjection, DisplayMode.compact,
      ...
      test('handles script injection-like strings', () {
        ...
        expect(scriptInjection, DisplayMode.compact,
      ...
      test('handles path traversal-like strings', () {
        ...
        expect(pathTraversal, DisplayMode.compact,
    ...
    group('Edge Cases', () {
      test('handles unicode characters', () {
        ...
        expect(unicode, DisplayMode.compact,
      ...
      test('handles line breaks', () {
        ...
        expect(lineBreak, DisplayMode.compact,
