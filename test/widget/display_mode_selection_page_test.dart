  ...
  group('DisplayModeSelectionPage Widget Tests', () {
    ...
    group('Initial Rendering', () {
      testWidgets('renders without crashing', (WidgetTester tester) async {
        ...
        expect(
          find.byType(DisplayModeSelectionPage),
          findsOneWidget,
      ...
      testWidgets('shows title "Choose Your Experience"', (
        ...
        expect(
          find.byKey(const Key('choose_experience_title')),
          findsOneWidget,
      ...
      testWidgets('shows description text', (WidgetTester tester) async {
        ...
        expect(
          find.text('Select how you want to use Habitus Faith'),
          findsOneWidget,
      ...
      testWidgets('shows "change anytime" message', (
        ...
        expect(
          find.byKey(const Key('change_anytime_text')),
          findsOneWidget,
          reason: 'Change anytime message should be displayed',
        );
        expect(
          find.textContaining('You can change this setting anytime'),
          findsOneWidget,
      ...
      testWidgets('has select mode button at bottom', (
        ...
        expect(
          find.widgetWithText(ElevatedButton, 'Select Mode'),
          findsOneWidget,
    ...
    group('Visual Feedback', () {
      testWidgets('compact mode card shows correct title and description', (
        ...
        expect(
          find.text('Essential features for daily habit tracking'),
          findsOneWidget,
      ...
      testWidgets('advanced mode shows all three features', (
        ...
        expect(
          find.text('Detailed habit analytics'),
          findsOneWidget,
    ...
    group('Accessibility', () {
      testWidgets('mode cards have semantic labels', (
        ...
        final simpleModeSemantics = tester.getSemantics(
          find.byKey(const Key('compact_mode_card')),
        );
        expect(
          simpleModeSemantics.label,
          isNotEmpty,
          reason: 'Simple mode card should have semantic label',
        );

        // Find semantics for advanced mode card
        final advancedModeSemantics = tester.getSemantics(
          find.byKey(const Key('advanced_mode_card')),
        );
        expect(
          advancedModeSemantics.label,
          isNotEmpty,
