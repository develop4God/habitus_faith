...
void main() {
  group('HabitModel - Lógica de rachas', () {
    ...
    test('Gap >1 día → streak = 1 (mantiene longestStreak)', () {
      ...
      expect(completed.longestStreak, 5,
          reason: 'Longest streak should be maintained');
    });
    ...
    test('longestStreak se actualiza si se supera', () {
      ...
      expect(completed.longestStreak, 5,
          reason: 'Should not update longest when current < longest');
      ...
      expect(completed2.longestStreak, 6,
          reason: 'Should update longest when surpassed');
    });
    ...
    test('fromFirestore() round-trip funciona', () {
      ...
      final restoredHabit = HabitModel(
        ...
        category: HabitCategory.values
            .firstWhere((e) => e.name == firestoreData['category']),
        ...
        lastCompletedAt:
            (firestoreData['lastCompletedAt'] as Timestamp).toDate(),
