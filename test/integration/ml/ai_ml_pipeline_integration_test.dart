...
void main() {
  group('AI/ML Pipeline Integration Tests', () {
    ...
    testWidgets('ML features calculator integrates with habit predictor', (tester) async {
      final predictor = AbandonmentPredictor();
      await predictor.initialize();
    ...
    testWidgets('ML predictor telemetry is available', (tester) async {
      ...
      expect(telemetry.containsKey('predictionCount') || telemetry.containsKey('version'), isTrue,
