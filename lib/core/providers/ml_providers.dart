...
final habitRiskProvider = FutureProvider.family<double, String>((ref, habitId) async {
    ...
    data: (habits) async {
      ...
      try {
        final risk = await predictor.predictAbandonmentRisk(
          ...
          hoursSinceReminder: MLFeaturesCalculator.calculateHoursFromReminder(habit, now),
        );
